...
=== 기록 초기화
#TODO : 기록 초기화 하루진단/칭찬처방/데이노트 개별 선택으로 세분화됨에 따라 변경 예정

operation::user/deleteAll[snippets='http-request,http-response']
operation::user/deleteAll[snippets='request-headers,response-fields']
