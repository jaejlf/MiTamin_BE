...
operation::user/updateProfileImg[snippets='http-request,http-response']
operation::user/updateProfileImg[snippets='request-headers,request-parts,response-fields']
